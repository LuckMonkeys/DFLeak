...
import sys
# sys.path.insert(0, './breaching/attacks/bfr/DifFace/')
# sys.path.insert(0, '/home/zx/breaching/breaching/attacks/bfr/DifFace/')
# sys.path.insert(0, '/home/zx/nfs/server3/breaching/breaching/attacks/bfr/DifFace/')
from breaching.attacks.bfr.DifFace.basicsr.utils import img2tensor
from breaching.attacks.bfr.DifFace.basicsr.archs.rrdbnet_arch import RRDBNet
from breaching.attacks.bfr.DifFace.basicsr.utils.realesrgan_utils import RealESRGANer
...
class BaseSampler:
    def __init__(self, configs):
        ...
        import random
        seed = random.randint(0, 1000) # add random seed
        self.setup_seed(seed=seed)    # setup seed
