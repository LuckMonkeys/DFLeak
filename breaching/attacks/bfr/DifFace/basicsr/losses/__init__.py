...
from breaching.attacks.bfr.DifFace.basicsr.utils.registry import LOSS_REGISTRY
...
_model_modules = [importlib.import_module(f'breaching.attacks.bfr.DifFace.basicsr.losses.{file_name}') for file_name in loss_filenames]
