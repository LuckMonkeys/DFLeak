...
from breaching.attacks.bfr.CodeFormer.facelib.detection.yolov5face.models.yolo import Model
from breaching.attacks.bfr.CodeFormer.facelib.detection.yolov5face.utils.datasets import letterbox
from breaching.attacks.bfr.CodeFormer.facelib.detection.yolov5face.utils.general import (
    check_img_size,
    ...
    def _postprocess(self, imgs, origimgs, pred, conf_thres, iou_thres):
        ...
        for image_id, origimg in enumerate(origimgs):
            ...
            for j in range(det.size()[0]):
                ...
                if box[3] - box[1] < self.min_face: #means we should keep the box[3]-box[1] >= self.min_face, this could be regularization?
                    continue
